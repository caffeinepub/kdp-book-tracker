...
export class Backend implements backendInterface {
    ...
    async addBook(arg0: string, arg1: string, arg2: number, arg3: bigint, arg4: number): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addBook(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async updateBook(arg0: bigint, arg1: string, arg2: string, arg3: number, arg4: bigint, arg5: number): Promise<boolean> {
        if (this.processError) {
            try {
